...
export const Contact = () => {
  ...
  return (
    <ContainerMaxWidth>
      ...
      <section
        className="animacionView my-margin-secciones-global md:grid md:grid-cols-2 mt-[1rem]
      ...
      >
        <div className=" md:grid md:place-items-center">
          <article>
            <div className="flex justify-center w-[62%] mx-auto">
              <b className="text-center text-[1.2rem] text-pretty  leading-[3rem]  md:text-[2rem]">
              ...
              <div className=" gap-5 flex justify-center w-full ">
                <div className="flex justify-center flex-col cursor-pointer">
                  <div className="flex justify-center p-[3px]">
                    <a
                      href="https://api.whatsapp.com/send?phone=5492494379804"
                      target="_blank"
                    >
        ...
        <form
          ...
          action="https://formspree.io/f/xzbnapnk"
          method="POST"
          className="flex flex-col justify-center"
        >
          <input
            className="claseTexto form-inputs-style  p-[1rem] "
            type="text"
            name="last name"
            id="last name"
            {...register("nombreYapellido")}
            placeholder={contactO.nombreYapellido}
          />
          <i className="text-[#e72d2d] text-center ">
            {errors?.nombreYapellido?.message &&
              "Ingrese su nombre y apellido ❗"}
          </i>

          <input
            className="claseEmail form-inputs-style  p-[1rem] "
            type="email"
            name="email"
            id="email"
            {...register("email")}
            placeholder="Email"
          />
          <p className="text-[#e72d2d] text-center ">
            {errors?.email?.message && "Ingresar email ❗"}
          </p>

          <input
            className="claseTel form-inputs-style  p-[1rem] "
            type="tel"
            name="number"
            id="number"
            {...register("celular")}
          ...
          />
          <p className="text-[#e72d2d] text-center ">
            {errors?.celular?.message && "Ingresa tu celular ❗"}
          </p>
          <textarea
            className="claseTextArea form-inputs-style h-[150px] min-h-[140px]  p-[1rem]  "
            name="message"
            id="message"
            cols="30"
            rows="10"
          ...
          <p className="text-[#e72d2d] text-center ">
            {errors.contactarmePara?.message &&
              "Pon la razon para colaborar, por favor"}
          </p>

          <button
            onClick={Submited}
            type="submit"
            className=" form-inputs-style buttons p-2  w-fit mx-auto  h-fit "
          >
            {contactO.enviar}
          </button>
        </form>
